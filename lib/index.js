...
var CaptainCabinetClient = module.exports = function constructor(options) {
  ...
  CCC.socket.on(MSG.fileProgress, function onFileProgress(data) {
    CCC.emit(MSG.fileProgress, data);
  });
...
CaptainCabinetClient.prototype.FileUploadRequest =
  ...
  'requestId': requestId, 'file': file, 'fileSize': fileSize};

  this.socket.emit(MSG.fileUploadRequest, {'roomName': roomName,
    'fileName': fileName, 'fileSize': fileSize, 'requestId': requestId,
    'userId': userId});
};
...
CaptainCabinetClient.prototype._FileUploadRequested =
  ...
  this.emit(MSG.fileUploadRequested, {
    'fileId': data.fileId,
